...
public class BackendApplication {
	...
	public CommandLineRunner init(EventRepository eventRepo, UserRepository userRepo){
		return args -> {
		    ...
		    Event event1 = createEvent(eventRepo, "BirthDayParty", "2002-06-22T17:00:00.000Z");
            Event event2 = createEvent(eventRepo, "Seminar", "2023-03-13T17:00:00.000Z");
		    User user = createUser(userRepo, event1, "Sri", "Murugan", "sri22062002@gmail.com", 27);
		};
	}
